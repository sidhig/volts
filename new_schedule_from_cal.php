...
?>
 ...
 <span style="float:left;"><input type="button" value="Back" onclick="back_cal();"></span>
<center>
...
<b>
<tr><td>From Date<span style="color:red;">*</span>:</td><td><input type="date" id="start_date" name="start_date" value="<?=$_POST['start_date']?>" min="<?=date('Y-m-d')?>"></td></tr>
...
<datalist id="poi_list" ><?=ltrim($substation_dl,"<option data-value='' value='Address' >")?></datalist>
<input list='poi_list' type="text" name="loc_need" id="loc_need" value=""></td></tr>
...
<tr><td>Voltage<span style="color:red;">*</span>:</td><td><input type="text" name="voltage" id="voltage" value="<?=$get_unit->voltage?>" ></td></tr>

<tr><td>MVA<span style="color:red;">*</span>:</td><td><input type="number" name="mva" id="mva" value="<?=$get_unit->mva?>" ></td></tr>
<tr><td>High Side<span style="color:red;">*</span>:</td><td><input type="text" name="high_side" id="high_side" value="<?=$get_unit->high_side?>" ></td></tr>
<tr><td>Low Side<span style="color:red;">*</span>:</td><td><input type="text" name="low_side" id="low_side" value="<?=$get_unit->low_side?>" ></td></tr>
...
<tr><th colspan='2'><center><input type="button" id="add_sch1" value="Add Schedule" > <input type="button" value="Back" onclick="back_cal();"></center></th></tr>
...
$("#start_date,#end_date").on('input', function() {
	if(($("#start_date").val()!='') && ($("#end_date").val())){
		...
		if(days<0){
			...
			var unit = "<?=$_POST['unit']?>";
			$.post( "check_sch_avail.php",{ start_date: $("#start_date").val(), end_date: $("#end_date").val(), unit:unit },function(data) { //alert(data);
