...
?>
 ...
 <span style="float:left;"><input type="button" value="Back" onclick="$('#schedule_month').load('schedule_motel_abbreviat.php');"></span>
<center>
	<form id="new_eqp"  >
		<h2>New Schedule</h2>
	<table border="0" style="border-spacing: 15px; ">
		...
		<tr>
			<td>Location Needed<span style="color:red;">*</span>:</td>
			<td>
				<datalist id="poi_list" ><?=ltrim($substation_dl,"<option data-value='' value='Address' >")?>
				</datalist>
				<input list='poi_list' type="text" name="loc_need" id="loc_need" value="<?=$forpoi->poi?>">
	        </td>
	    </tr>
		<tr>
			<td>Contact Name:</td>
		...
		<tr>
			<th colspan='2'><center>
				...
				<input type="button" value="Back" onclick="$('#schedule_month').load('schedule_motel_abbreviat.php');"></center>
			</th>
		</tr>
