<?session_start();
 ...
 $obj_main = $conn->query("SELECT  * FROM `tbl_role` where role_name='".$_SESSION['LOGIN_user']."' ")->fetch_object();
 ?>
...
<!-- <h1 style="font-size:2.2rem;"><b>Add User</b></h1><br> -->
...
<!--   <input type="button"  id="edit_role" value="Edit Role" style="height:25px;margin-top:19px;"> -->
  ...
  <div class="colm" style="margin-top:2vh;">
   ...
   <form id='new_user_form' name="new_user_form">
    <center>
       <!-- <div style="border:1px solid #D3D3D3;width: 40vw;"> -->
        <table>
        <tr>
          <td>
   <table style="font-size:small;">
					  <tr>
                            ...
                            <td><input id="name" name="user_name" type="text" class="intp" placeholder="Name">
                            </td>
                      </tr>
					  <tr>
                      ...
                      <tr>
                            ...
                            <td><input id="email" name="user_email" type="text" class="intp" placeholder="Email">
                            </td>
                      </tr>
                      <tr>
                          <td><strong class="stg">Username:</strong></td>
                          <td><input type='hidden' name='qry_type' value='add'>
                            <input id="username" name="user_username" type="text" class="intp" style="background-color:#D3D3D3;" placeholder="Username" autocomplete="new-username">
                          </td>
                      </tr>
                      <tr>
                            <td><strong class="stg">Password:</strong></td>
                            <td><input id="password" name="user_password" type="password" class="intp" placeholder="Password" autocomplete="new-password">
                            </td>
                      </tr>
  ...
  <input onclick='validateuser();' type='button'  value="Add User" class="btn btn-primary" style="height:5vh;width:20vw;margin-top: 3vh;">
</center>
...
<td>
     <table class="table" id="opco_tab" style="border:1px solid black;border-collapse: initial;font-size:smaller;">
      <tr><th>Company</th></tr>     
        <? $sql = "SELECT * from role_opco where if('".$_SESSION['ROLE_opco']."'='0',1,id in (".$_SESSION['ROLE_opco'].")) order by name asc";
 ...
 <!--    </div>
    ...
    <div style="float:left;border: 1px solid black;"> -->
      ...
      <tr><th>Section</th></tr>
         <? $sql = "SELECT * from role_primary where if('".$_SESSION['ROLE_primary']."'='0',1,id in (".$_SESSION['ROLE_primary'].")) order by name asc";
         if ($result = $conn->query($sql)) { 
              while($obj = $result->fetch_object()){ ?>
              <script>
...
<!--     </div>
    ...
    <div style="float:left;border: 1px solid black;"> -->
      ...
      <tr><th>Business Unit</th></tr>
         <? $sql = "SELECT * from role_group where if('".$_SESSION['ROLE_group']."'='0',1,id in (".$_SESSION['ROLE_group'].")) order by name asc";
         if ($result = $conn->query($sql)) { 
              while($obj = $result->fetch_object()){ ?>
                <script>
...
<!--     </div>
    ...
    <div style="float:left;border: 1px solid black;"> -->
      ...
      <tr><th>Location</th></tr>
         <? $sql = "SELECT * from role_dept where if('".$_SESSION['ROLE_dept']."'='0',1,id in (".$_SESSION['ROLE_dept'].")) order by name asc";
         if ($result = $conn->query($sql)) { 
              while($obj = $result->fetch_object()){ ?>
                <script>
...
<!--     </div>
   ...
   <!--  </div>
    ...
    <div style="/*float:left;border: 1px solid black;*/"> -->
      ...
      <tr><th>Equipment</th></tr>
         <? $sql = "SELECT * from tbl_eqptype where if('".$_SESSION['ROLE_eqp']."'='0',1,id in (".$_SESSION['ROLE_eqp'].")) order by eq_name asc";
         if ($result = $conn->query($sql)) { 
              while($obj = $result->fetch_object()){ ?>
                <script>
 ...
 <!--    </div>
    ...
    <div style="float:left;border: 1px solid black;"> -->
      ...
      <tr><th>View</th></tr>
         <? $sql = "(SELECT * from role_view where if('".$_SESSION['ROLE_view']."'='0',1,id in (".$_SESSION['ROLE_view'].")) ) order by name asc";
         if ($result = $conn->query($sql)) { 
              while($obj = $result->fetch_object()){ ?>
               <script>
  ...
  <!--   </div>
    ...
    <div style="float:left;border: 1px solid black;"> -->
      ...
      <tr><th>Report</th></tr>
         <? $sql = "SELECT * from role_report where if('".$_SESSION['ROLE_view']."'='0',1,id in (".$_SESSION['ROLE_view'].")) order by name asc";
         if ($result = $conn->query($sql)) { 
              while($obj = $result->fetch_object()){ ?>
                 <script>
...
<!--  </div>
 <div style="float:left;border: 1px solid black;"> -->
      ...
      <tr><th>Emf</th></tr>
         <? $sql = "SELECT * from role_emf where if('".$_SESSION['ROLE_view']."'='0',1,id in (".$_SESSION['ROLE_view'].")) order by name asc";
         if ($result = $conn->query($sql)) { 
              while($obj = $result->fetch_object()){ ?>
                 <script>
