...
{
	$result1 = mysql_query("select DeviceName,DeviceIMEI from devicedetails where DeviceName !='' and DeviceName is not null and
...
DeviceType = '".$_REQUEST["equip_type"]."' order by DeviceName ");
