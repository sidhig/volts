...
<tr>
	...
	<td align="right" style='text-align:right;width: 30%;'>Relocation Sheet Number: <strong><? date_default_timezone_set("EST5EDT"); ?><span id="trip_sheet_no"><?=$trip_no = date('YmdHis')?></span></strong></td>
</tr>
</table></center>
...
<input type="hidden" name="ts_or_rl" value='rl' >
<input type="hidden" name="trip_form" value="new"  />
  <div class="row">
		...
		<div class="col-sm-3" >
		  <input name="del_date" id="del_date" type="date" style="background-color: rgb(206, 206, 206);" class="int" value=<?php print(date("Y-m-d"));?>>     
		</div>
		<div class="col-sm-1" ></div>
		<div class="col-sm-2" >
		...
		<div class="col-sm-3" >
		 <input type="date" class="int"  name="req_date" id="req_date" style="background-color: rgb(206, 206, 206);">
		</div>
   </div>
...
/**/
  ...
  <center>
	  ...
	  <input type="submit" value="Print" onclick="" /> 
