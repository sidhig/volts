...
//$("#status").empty();
	//var dateFormat = $.datepicker.formatDate('yy-mm-dd', new Date($(this).html()));
		//$.post( "Equipment Abbreviated Schedule.php",{  },function(data) {
		//$("#schedule_abbr").empty();
...
function send_form_data(){
			...
			var other_data = $('#new_eqp').serializeArray();
	...
	$.ajax({
				...
				success : function(data) { 
							...
							$("#schedule_abbr").empty();
							$("#schedule_abbr").load('Equipment Abbreviated Schedule.php');
						}
